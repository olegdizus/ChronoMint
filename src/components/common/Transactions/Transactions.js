...
import { CircularProgress, Divider, Paper, Table, TableBody, TableFooter, TableHeader, TableHeaderColumn, TableRow, TableRowColumn } from '@material-ui/core'
...
const mapStateToProps = (state) => {
  const networkState = state.get(DUCK_NETWORK)
  return {
    account: state.get(DUCK_SESSION).account,
    selectedNetworkId: networkState.selectedNetworkId,
    selectedProviderId: networkState.selectedProviderId,
